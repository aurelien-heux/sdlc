...
include("libs:adapter-git")
include("libs:governance")
include("agents:agent-spec")
include("agents:agent-intent")
include("agents:agent-design")
include("agents:agent-backlog")
include("agents:agent-testgen")
include("tools:workspace-cli")
